...
ostream& operator <<(ostream& output, poliklinik& v) {
	cout << "poliklinikID :" << v.poliklinikID << "  bolum  :" << v.bolum << "  isBaslamaSaati  :" << v.isBaslamaSaati << "  isBitisSaati  :" << v.isBitisSaati << endl;
